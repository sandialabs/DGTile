...
struct AMRBorderData {
  Message<View<double***>> child_soln[NBORDER_CHILD];
  Message<View<double**>> child_avg_soln[NBORDER_CHILD];
  View<double****> soln;
...
class Border {
  ...
  private:
    Message<View<double***>> m_soln[ndirs];
    Message<View<double**>> m_avg_soln[ndirs];
  ...
  public:
    ...
    [[nodiscard]] Message<View<double***>>& soln(int msg_dir);
    [[nodiscard]] Message<View<double**>>& avg_soln(int msg_dir);
    [[nodiscard]] AMRBorderData& amr(int msg_dir);
    [[nodiscard]] static_array<View<double***>, ndirs> soln() const;
    [[nodiscard]] static_array<View<double****>, ndirs> amr_soln() const;
